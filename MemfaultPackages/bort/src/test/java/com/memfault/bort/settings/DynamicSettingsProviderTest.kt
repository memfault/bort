...
internal val EXPECTED_SETTINGS_DEFAULT = FetchedSettings(
    ...
    metricsCpuInterestingProcesses = emptySet(),
    metricsCpuProcessReportingThreshold = 50,
    metricsCpuProcessLimitTopN = 10,
...
private val EXPECTED_SETTINGS = EXPECTED_SETTINGS_DEFAULT.copy(
    ...
    metricsCpuInterestingProcesses = setOf("com.android.systemui", "com.memfault.bort"),
...
internal val SETTINGS_FIXTURE = """
            {
              "data": {
                ...
                "metrics.cpu_interesting_processes": ["com.android.systemui", "com.memfault.bort"],
                "metrics.cpu_process_reporting_threshold": 70,
