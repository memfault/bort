...
class FetchedDeviceConfigContainerTest {
                ...
                "memfault": {
                    "bort": {
                        "sdk-settings": {
                            ...
                            "http_api.device_base_url": "http://localhost:5000",
                            "http_api.files_base_url": "http://localhost:5000",
                            "http_api.ingress_base_url": "http://localhost:5000",
                    ...
                    "sampling": {
                        "attributes.resolution": "normal",
                        "debugging.resolution": "normal",
                        "logging.resolution": "normal",
                        "timeseries.resolution": "normal"
                    }
                }
            }
        }
    ...
    fun deserializeResponse() {
        ...
        assertEquals("normal", result.memfault!!.sampling.attributesResolution)
