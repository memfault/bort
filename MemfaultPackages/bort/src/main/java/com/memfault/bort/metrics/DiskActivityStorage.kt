...
import com.memfault.bort.DiskActivityPrefs
import com.memfault.bort.PREFERENCE_DISK_ACTIVITY
...
class RealDiskActivityStorage @Inject constructor(
    @DiskActivityPrefs sharedPreferences: SharedPreferences,
