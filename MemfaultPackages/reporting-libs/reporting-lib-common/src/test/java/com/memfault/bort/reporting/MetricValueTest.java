...
public class MetricValueTest {
  ...
  private static final long uptimeMs = 1234567;
  private static final String reportType = "heartbeat";
  private static final String reportName = null;
  private static final int version = 3;

  @Test
  public void testSerializeStringMetricWithNoUptime() throws JSONException {
    ...
    String expectedJson =
        "{\"reportType\":\"heartbeat\",\"metricType\":\"property\",\"dataType\":\"string\","
            ...
            + "\"aggregations\":[\"LATEST_VALUE\"],\"value\":\"abc\",\"uptimeMs\":-1,"
            + "\"timestampMs\":123456}";
  ...
  public void testSerializeStringMetric() throws JSONException {
    MetricValue metric = new MetricValue("metric_string", reportType,
        singletonList(LATEST_VALUE), false, MetricType.PROPERTY, DataType.STRING,
        true, timeMs, uptimeMs, "abc", null, null, version,
        reportName);
    String expectedJson =
        "{\"reportType\":\"heartbeat\",\"metricType\":\"property\",\"dataType\":\"string\","
            + "\"eventName\":\"metric_string\",\"carryOver\":true,\"version\":3,"
            + "\"aggregations\":[\"LATEST_VALUE\"],\"value\":\"abc\",\"uptimeMs\":1234567,"
            + "\"timestampMs\":123456}";
    assertEquals(expectedJson, metric.toJson());
    assertEquals(metric, MetricValue.fromJson(expectedJson));
  }
  ...
  public void testSerializeInternalMetric() throws JSONException {
    ...
    String expectedJson =
        "{\"reportType\":\"heartbeat\",\"metricType\":\"property\",\"internal\":true,"
            ...
            + "\"uptimeMs\":1234567,\"timestampMs\":123456}";
    assertEquals(expectedJson, metric.toJson());
    assertEquals(metric, MetricValue.fromJson(expectedJson));
  }
  ...
  public void testSerializeNumberMetric() throws JSONException {
    MetricValue metric = new MetricValue("metric_number", reportType,
        ...
        false, timeMs, uptimeMs, null, 1.0, null, version,
        reportName);
    String expectedJson =
        "{\"reportType\":\"heartbeat\",\"metricType\":\"counter\",\"dataType\":\"double\","
            + "\"eventName\":\"metric_number\",\"carryOver\":false,\"version\":3,"
            + "\"aggregations\":[\"SUM\"],\"value\":1,\"uptimeMs\":1234567,\"timestampMs\":123456}";
    assertEquals(expectedJson, metric.toJson());
    assertEquals(metric, MetricValue.fromJson(expectedJson));
  }

  @Test
  public void testSerializeFinishReportWithNoUptime() throws JSONException {
    //noinspection deprecation
    String reportJson =
        (new FinishReport(timeMs, version, reportType, false, reportName)).toJson();
    String expectedJson = "{\"reportType\":\"heartbeat\",\"version\":3,\"uptimeMs\":-1,"
        + "\"timestampMs\":123456}";
  ...
  public void testSerializeFinishReport() throws JSONException {
    String reportJson =
        (new FinishReport(timeMs, uptimeMs, version, reportType, false, reportName))
            .toJson();
    String expectedJson = "{\"reportType\":\"heartbeat\",\"version\":3,\"uptimeMs\":1234567,"
        + "\"timestampMs\":123456}";
    assertEquals(expectedJson, reportJson);
  }
  ...
  public void testSerializeRollingFinishReport() throws JSONException {
    String reportJson =
        (new FinishReport(timeMs, uptimeMs, version, reportType, true, reportName)).toJson();
    String expectedJson =
        "{\"reportType\":\"heartbeat\",\"startNextReport\":true,\"version\":3,\"uptimeMs\":1234567,"
            + "\"timestampMs\":123456}";
    assertEquals(expectedJson, reportJson);
  }
}
